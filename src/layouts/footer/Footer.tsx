    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.companyInformation}>
                ...
                {/* <!-- 고객센터 정보 목록 --> */}
                <ul className={styles.companyInformationList}>
                    <li>
                        <span>
            ...
            <div className={styles.copyrightArea}>
                <div className={styles.copyrightAreaInner}>
                    ...
                    <div className={styles.copyright}>
                        <span>
                            사이버몰 내 판매되는 상품 중에는 쿠팡에 등록한 개별
                            판매자가 판매하는 마켓플레이스(오픈마켓) 상품이
                            포함되어 있습니다.
                        </span>
                        <span>
                            마켓플레이스(오픈마켓) 상품의 경우 쿠팡은
                            통신판매중개자이며 통신판매의 당사자가 아닙니다.
                        </span>
                        <span>
                            쿠팡은 마켓플레이스(오픈마켓) 상품, 거래정보 및 거래
                            등에 대하여 책임을 지지 않습니다.
                        </span>
                        <span>
                            쿠팡은 소비자 보호와 안전거래를 위해
                            신뢰관리센터(CM112@coupang.com)를 운영하고 있으며,
                            관련 분쟁이 발생할 경우 별도의 분쟁처리절차에 의거
                            분쟁이 처리됩니다.
                        </span>
                        <small className={styles.copyrightText}>
                            Copyright &copy; Coupang Corp. 2010-2020 All Right
                            Reserved.
                        </small>
                    </div>
